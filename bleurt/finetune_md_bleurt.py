...
from bleurt import encoding_md_bleurt
from bleurt import model_md_bleurt
...
def run_finetuning_pipeline(train_set, dev_set, run_in_lazy_mode=True):
  ...
  encoding_md_bleurt.encode_and_serialize(
      train_set,
      train_tfrecord,
  ...
  model_md_bleurt.run_finetuning(train_tfrecord, dev_tfrecord, train_eval_fun)
